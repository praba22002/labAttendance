...
<br>
<div class="title">
<font style="font-size: 24pt; font-weight: bold; font-family: monospace;">SJC LAB ATTENDANCE - Date Wise Report</font>
</div>
</div>
<br>
<hr size="1px" color="white" ></hr>
    <form action="" method="post">
        <div >
            <font  style="font-size: 16pt; font-weight: bold; font-family: monospace;" >
  ...
  include_once 'db.php';
        ...
        $sql = "SELECT student_id, in_time, out_time, date FROM attendance WHERE date BETWEEN '$from_date' AND '$to_date'";
